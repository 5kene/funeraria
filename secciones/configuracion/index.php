        ...
        <form action="asignar_rol.php" method="post" enctype="multipart/form-data">
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" name="rol" id="rol" placeholder="gerente"/>
                </div>
            </div>
            <div class="row">
   ...
   <div class="modal-content">
       ...
       <div class="modal-body">
           <form id="editUserForm" method="post" action="editar.php">
               ...
               <input type="hidden" id="editUserRole" name="role" required>
               <div class="form-group">
...
document.querySelectorAll('.edit-user').forEach(function(button) {
    button.onclick = function() {
        ...
        document.getElementById('editUserRole').value = userRole;  // Nuevo campo oculto para el rol
